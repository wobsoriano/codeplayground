    ...
    <nav class="bg-white dark:bg-gray-900">
        <div class="flex items-center justify-between h-full px-6 ">
            <div class="flex items-center justify-between">
                <div>
                    <a class="text-2xl font-bold text-gray-900 dark:text-white lg:text-xl hover:text-gray-700 dark:hover:text-gray-300" href="#">Code Playground</a>
                </div>
            </div>

            <div class="flex justify-center lg:flex lg:mt-0 lg:-mx-2">
                <a class="relative mx-2 text-gray-700 dark:text-gray-200 hover:text-gray-600 dark:hover:text-gray-300" href="https://github.com/wobsoriano/code-playground" target="_BLANK">
                ...
                <a class="relative mx-2 text-gray-700 dark:text-gray-200 hover:text-gray-600 dark:hover:text-gray-300" href="#" @click.prevent="toggleDark">
