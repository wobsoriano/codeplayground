...
<nav class="bg-white dark:bg-gray-800">
        <div class="px-6 py-4 mx-auto flex justify-between items-center">
            <div class="flex items-center justify-between">
                <div>
                    <a class="text-2xl font-bold text-gray-800 dark:text-white lg:text-3xl hover:text-gray-700 dark:hover:text-gray-300" href="#">Code Playground</a>
                </div>
            </div>

            <div class="flex justify-center lg:flex lg:mt-0 lg:-mx-2">
                <a class="mx-2 relative text-gray-700 dark:text-gray-200 hover:text-gray-600 dark:hover:text-gray-300" href="https://github.com/wobsoriano/code-playground" target="_BLANK">
                ...
                <a class="mx-2 relative text-gray-700 dark:text-gray-200 hover:text-gray-600 dark:hover:text-gray-300" href="#" @click.prevent="toggleDark">
